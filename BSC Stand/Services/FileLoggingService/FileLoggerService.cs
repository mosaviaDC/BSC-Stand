...
namespace BSC_Stand.Services
{
    public class FileLoggerService : IFileLoggerService
    {
        ...
        {
            FilePath = $@"{Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments)}\СИ СГЭ\Отчеты\CSV\Отчет от {DateTime.Now.Day}.{DateTime.Now.Month}.{DateTime.Now.Year} {DateTime.Now.Hour}.{DateTime.Now.Minute}.csv";
